...
- **Repo-scoped sessions** — memory is shared across git worktrees of the same repo
...
1. Environment variables: `HONCHO_API_KEY`, `HONCHO_URL`, `HONCHO_WORKSPACE_ID`, `HONCHO_PEER_NAME`, `HONCHO_AI_PEER`, `HONCHO_ENABLED`
2. Config file: `~/.honcho/config.json`
3. Defaults (workspace: `pi`, AI peer: `pi`, user peer: `$USER`)
